...
import { LegalEntitiesTable } from '../../../../modules/organisation/components/legal-entities-table';
...
interface LegalEntitiesPageClientProps {
  title: string;
  description: string;
}

export function LegalEntitiesPageClient({ title, description }: LegalEntitiesPageClientProps) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Link
            href={ROUTES.TENANT.ORGANISATION.LEGAL_ENTITY_NEW}
          ...
          >
            + {t('organisation.legalEntities.createButton')}
          </Link>
        }
      />
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div className="relative flex-1">
          <input
            ...
            placeholder={t('organisation.legalEntities.searchPlaceholder')}
        ...
        <select
          value={statusFilter}
          onChange={(e) => { setStatusFilter(e.target.value as OrgEntityStatus | ''); setPage(1); }}
      ...
      <LegalEntitiesTable data={data?.data ?? []} isLoading={isLoading} />
