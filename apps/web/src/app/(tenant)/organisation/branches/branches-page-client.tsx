...
import { BranchesTable } from '../../../../modules/organisation/components/branches-table';
...
export function BranchesPageClient({ title, description }: BranchesPageClientProps) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Link
            href={ROUTES.TENANT.ORGANISATION.BRANCH_NEW}
          ...
          >
            + {t('organisation.branches.createButton')}
          </Link>
        }
      />
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div className="relative flex-1">
          <input
            ...
            placeholder={t('organisation.branches.searchPlaceholder')}
      ...
      <BranchesTable data={data?.data ?? []} isLoading={isLoading} />
