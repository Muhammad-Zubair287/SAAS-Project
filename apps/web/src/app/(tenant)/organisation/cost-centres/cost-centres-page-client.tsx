...
import { CostCentresTable } from '../../../../modules/organisation/components/cost-centres-table';
import { useCostCentres } from '../../../../modules/organisation/hooks/use-cost-centres';
...
interface CostCentresPageClientProps {
  title: string;
  description: string;
}

export function CostCentresPageClient({ title, description }: CostCentresPageClientProps) {
  ...
  const { data, isLoading, isError, refetch } = useCostCentres({
    page,
    pageSize,
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Link
            href={ROUTES.TENANT.ORGANISATION.COST_CENTRE_NEW}
          ...
          >
            + {t('organisation.costCentres.createButton')}
          </Link>
        }
      />
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
        <div className="relative flex-1">
          <input
            ...
            placeholder={t('organisation.costCentres.searchPlaceholder')}
