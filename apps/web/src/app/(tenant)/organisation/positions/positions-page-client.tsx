...
import { PositionsTable } from '../../../../modules/organisation/components/positions-table';
...
export function PositionsPageClient({ title, description }: PositionsPageClientProps) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Link
            href={ROUTES.TENANT.ORGANISATION.POSITION_NEW}
          ...
          >
            + {t('organisation.positions.createButton')}
          </Link>
        }
      />
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div className="relative flex-1">
          <input
            ...
            placeholder={t('organisation.positions.searchPlaceholder')}
      ...
      <PositionsTable data={data?.data ?? []} isLoading={isLoading} />
